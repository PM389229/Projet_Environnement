...
# L'Endpoint suivant a pour but de récupérer toutes les données
...
#L'Endpoint GET 'api/data' suivant récupère les données par région
#On utilise collection.find pour récupérer les données de la région demandée sans l'ID 
#Ces données par région demandée sont converties en listes
#On convertit les ObjectID en en chaines(str) pour les rendre JSON serialisables
